<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrearOpinion.aspx.cs" Inherits="ProyectoConcurso.Usuario.CrearOpinion" %>
            ...
            <div class="row">
                ...
                <div class="row center center-align">
                 ...
                 <%--         <asp:TextBox ID="TextBox1" runat="server" CssClass="materialize-textarea" textmode="multiline"></asp:TextBox>--%>
                     ...
                     <div class="col s12">
                        <asp:Label ID="Label3" runat="server" Text="Pregunta 2" style="font-size: x-large"></asp:Label>
                    </div>
                    ...
                    <div class="col s12">
                     ...
                     <div class="col s12">
                        <asp:Label ID="Label4" runat="server" Text="Pregunta 3" style="font-size: x-large"></asp:Label>
                    </div>
                    <div class="col s12">
                     ...
                     <div class="col s12">
                        <asp:Label ID="Label5" runat="server" Text="Pregunta 4" style="font-size: x-large"></asp:Label>
                    </div>
                    <div class="col s12">
                     ...
                     <div class="col s12">
                        <asp:Label ID="Label6" runat="server" Text="Pregunta 5" style="font-size: x-large"></asp:Label>
                    </div>
                    <div class="col s12">
