<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultarQueja.aspx.cs" Inherits="ProyectoConcurso.Usuario.ConsultarQueja" %>
        ...
        <!-- Nav Info -->
         ...
         <div class="container">
            <div class="row">
                ...
                <div class="row">
                     <div class="row">
                    <h6 class="center-align">Ingrese el id de tu Queja a consultar</h6>
                </div>
