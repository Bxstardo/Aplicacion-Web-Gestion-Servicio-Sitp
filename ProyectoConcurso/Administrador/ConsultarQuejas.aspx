<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultarQuejas.aspx.cs" Inherits="ProyectoConcurso.Administrador.ConsultarQuejas" %>
        ...
        <!-- Nav Info -->
          ...
          <div class="container">
            <div class="row">
                ...
                <div class="row">
                     <div class="row">
                    <h6 class="center-align col s12">Ingrese el id de tu Queja a consultar</h6>
                </div>
