<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaginaPrincipalLoginA.aspx.cs" Inherits="ProyectoConcurso.PaginaPrincipalLoginA" %>
...
<li>
             ...
             <li>
                    ...
                    <li>
                        ...
                        <ul class="full-width">
                                  <li><a href="Administrador/AgregarNoticia.aspx" class="waves-effect waves-light">Agregar noticia</a></li>
        ...
        <div class="ContentPage-Nav full-width blue darken-3">
            <ul class="full-width">
                ...
                <li style="padding:0 5px;">
                    <asp:Label ID="Label1" runat="server" Text="Admin01" CssClass="white-text"></asp:Label></li>
